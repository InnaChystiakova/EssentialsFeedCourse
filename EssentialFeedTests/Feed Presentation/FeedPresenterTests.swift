...
final class FeedPresenterTests: XCTestCase {
    ...
    func testTitleIsLocalized() {
        XCTAssertEqual(FeedPresenter.title, localized("FEED_VIEW_TITLE"))
    }
    
    func testInitDoesNotSendMessageToView() {
        let (_, view) = makeSUT()
        
        XCTAssertTrue(view.messages.isEmpty, "Expected no view messages")
    }
    
    func testDidStartLoadingFeedDisplaysNoErrorMessageAndStartsLoading() {
    ...
    func testDidFinishLoadingFeedDisplaysFeedAndStopsLoading() {
        let (sut, view) = makeSUT()
    ...
    func testDidFinishLoadingFeedWithErrorDisplaysLocalizedErrorMessagesAndStopsLoading() {
        let (sut, view) = makeSUT()

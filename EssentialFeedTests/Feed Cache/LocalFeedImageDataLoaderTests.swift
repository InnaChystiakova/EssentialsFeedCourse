...
class LocalFeedImageDataLoaderTests: XCTestCase {
    ...
    func testLoadImageDataFromURLFailsOnStoreError() {
        let (sut, store) = makeSUT()
    ...
    func testLoadImageDataFromURLDeliversNotFoundErrorOnNotFound() {
        let (sut, store) = makeSUT()
    ...
    func testLoadImagDataFromURLDeliversStoreedDataOnFoundData() {
        let (sut, store) = makeSUT()
    ...
    func testLoadImageDataFromURLDoesNotDeliverResultAfterSUTInstanceHasBeenDeallocated() {
        let store = StoreSpy()
    ...
    func testLoadImageDataForURLRequestsImageDataInsertionForURL() {
        let (sut, store) = makeSUT()
        let url = anyURL()
        let data = anyData()

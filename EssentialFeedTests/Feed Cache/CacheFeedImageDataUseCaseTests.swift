...
class CacheFeedImageDataUseCaseTests: XCTestCase {
    ...
    func testSaveImageDataFromURLFailsOnStoreInsertionError() {
        let (sut, store) = makeSUT()
    ...
    func testSaveImageDataFromURLSucceedesOnSuccessfulStoreInsertion() {
        let (sut, store) = makeSUT()
        
        expect(sut, toCompleteWith: .success(()), when: {
            store.completeInsertionsSuccessfully()
        })
    }
    
    func testSaveImageDataFromURLDoesNotDeliversResultAfterSUTInstance() {

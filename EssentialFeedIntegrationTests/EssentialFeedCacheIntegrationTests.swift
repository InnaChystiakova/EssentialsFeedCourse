...
final class EssentialFeedCacheIntegrationTests: XCTestCase {
    ...
    func testLoadDeliversItemsSavedOnASeparateInstance() {
        ...
        sutToPerformSave.save(feed) { saveError in
            XCTAssertNil(saveError, "Expected to save feed seccessfully")
            saveExp.fulfill()
        }
    ...
    func testsaveOverridesItemsSavedOnASeparateInstance() {
        ...
        let saveExp1 = expectation(description: "Wait to save completion")
        ...
        let saveExp2 = expectation(description: "Wait to save completion")

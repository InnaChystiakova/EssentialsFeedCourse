...
final class FeedViewControllerTests: XCTestCase {
    ...
    func testLoadFeedCompletionrendersSuccessfullyLoadedFeed() {
    ...
    func testLoadFeedCompletionDoesNotAlterCurrentRenderingStateOnError() {
    ...
    func testFeedImageViewLoadsImageURLWhenVisible() {
    ...
    func testFeedImageViewCancelsImageLoadingWhenNotVisibleAnymore() {
        let image0 = makeImage(url: URL(string: "http://url-0.com")!)
        let image1 = makeImage(url: URL(string: "http://url-0.com")!)
        let (sut, loader) = makeSUT()
    ...
    func testFeedImageViewLoadingIndicatorIsVisibleWhileLoadingImage() {
        let (sut, loader) = makeSUT()
    ...
    func testFeedImageViewRendersImageLoadedFromURL() {
        let (sut, loader) = makeSUT()
    ...
    func testFeedImageViewRetryButtonIsVisibleOnImageURLLoaderError() {
        let (sut, loader) = makeSUT()
    ...
    func testFeedImageViewRetryButtonIsVisibleOnInvalidImageData() {
        let (sut, loader) = makeSUT()
    ...
    func testFeedImageViewretryActionRetriesImageLoad() {
        let image0 = makeImage(url: URL(string: "http://url-0.com")!)
        let image1 = makeImage(url: URL(string: "http://url-0.com")!)
        let (sut, loader) = makeSUT()
    ...
    func testFeedImageViewPreloadsImageURLWhenNearVisible() {
        let image0 = makeImage(url: URL(string: "http://url-0.com")!)
        let image1 = makeImage(url: URL(string: "http://url-0.com")!)
        let (sut, loader) = makeSUT()
    ...
    func testFeedImageViewCancelsImageURLPreloadingWhenNotNearVisibleAnymore() {
        let image0 = makeImage(url: URL(string: "http://url-0.com")!)
        let image1 = makeImage(url: URL(string: "http://url-0.com")!)
        let (sut, loader) = makeSUT()
    ...
    func testFeedImageViewDoesNotRenderLoadedImageWhenNotVisibleAnymore() {
        let (sut, loader) = makeSUT()
        sut.loadViewIfNeeded()
        loader.completeFeedLoading(with: [makeImage()])
    ...
    private func assertThat(_ sut: FeedViewController, hasViewConfiguratorFor image: FeedImage, at index: Int, file: StaticString = #file, line: UInt = #line) {
